...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/${NC_FQDN}/fullchain.pem;   # managed by certbot on host machine
    ssl_certificate_key /etc/letsencrypt/live/${NC_FQDN}/privkey.pem; # managed by certbot on host machine
